...
public class TestCase22 extends TestCase21 {
  ...
  */
  ...
  public void run() throws Exception {
    ...
    com.github.geko444.im4java.utils.BatchConverter.Mode runMode = com.github.geko444.im4java.utils.BatchConverter.Mode.SEQUENTIAL;
    if (iArgs != null && iArgs.length > 2) {
      if (iArgs[2].equals("par")) {
	runMode = com.github.geko444.im4java.utils.BatchConverter.Mode.PARALLEL;
      } else if (iArgs[2].equals("batch")) {
	runMode = com.github.geko444.im4java.utils.BatchConverter.Mode.BATCH;
      }
    }
  ...
  */
  ...
  class MyBatchConverter extends com.github.geko444.im4java.utils.BatchConverter {
    ...
    */
    ...
    MyBatchConverter(Mode pMode, List<String> pImages) {
      super(pMode);
      iImages = pImages;
    ...
    */
    ...
    public void terminated() {
      ...
      List<ConvertException> failed = getFailedConversions();
      if (failed != null && failed.size()>0) {
	System.err.println("Failed images:");
	for (ConvertException ex:failed) {

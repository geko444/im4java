...
/**
   ...
   and {@link com.github.geko444.im4java.process.ProcessExecutor#shutdownNow} methods.
...
public class TestCase16b extends AbstractTestCase {
  ...
  */
  ...
  public void run() throws Exception {
    ...
    com.github.geko444.im4java.process.ProcessExecutor exec = new ProcessExecutor(2);

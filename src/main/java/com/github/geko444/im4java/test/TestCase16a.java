...
public class TestCase16a extends AbstractTestCase {
  ...
  */
  ...
  public void run() throws Exception {
    ...
    com.github.geko444.im4java.process.ProcessTask pt = display.getProcessTask(dispOp);
  ...
  */
  ...
  private void waitSleep(ExecutorService pExec, com.github.geko444.im4java.process.ProcessTask pPT)
  ...
  */
  ...
  private void waitGet(com.github.geko444.im4java.process.ProcessTask pPT) throws Exception {
    try {
      System.err.println("waiting 10 seconds for process to finish with get ...");
      com.github.geko444.im4java.process.ProcessEvent pe = pPT.get(10,TimeUnit.SECONDS);
